...
VENDOR_SKIP_FILES=(
    ...
    "bin/hw/android.hardware.usb@1.3-service.barbet"
    ...
    "etc/init/android.hardware.usb@1.3-service.barbet.rc"
    ...
    "etc/vintf/manifest/android.hardware.usb@1.3-service.barbet.xml"
